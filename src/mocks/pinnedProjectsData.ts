...
export const pinnedProjectsData = [
    ...
    // },
    {
        name: "JoySystem App Server",
        liveLink: undefined,
        repoLink: "https://github.com/Seila-dev/joy-system-server",
        desktopImg: portJoysystemDesktop,
        mobileImg: portJoysystemMobile,
        description: "Servidor backend do JoySystem, desenvolvido com Node.js, Express e PostgreSQL. Gerencia autenticação, criação de tarefas, anotações, sistema de moedas e integração futura com IA. ",
        technologies: [postgreLogo, typescriptLogo, nodeLogo, expressLogo, prismaLogo]
    },
    {
        name: "JoySystem App - Productivity Manager",
